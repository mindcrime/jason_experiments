...
@a1            
+stock(beer,N) : N < 3 // available(beer,fridge) 
    <- .print( "beer stock is down to ", N ); .print( "Ordering more beer from supermarket"); .send( supermarket, achieve, order(beer,5)). // -available(beer,fridge).               
