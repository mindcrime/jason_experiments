...
@h1
+!has(owner,beer)[source(owner)] : available(beer,fridge) & not too_much(beer) // if there is beer available and the owner is not over the daily limit
